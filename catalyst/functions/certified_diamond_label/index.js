// Catalyst Advanced I/O function (Node.js): certified-diamonds label.
// Forked from print_label_node -- same fetch/render pipeline, except the
// right-hand cert row always shows "<LAB>-<certificate_no>" (no mm_size
// fallback, no conditional logic), since certified stock always has a
// real lab certificate. Use print_label_node instead for uncertified/
// parcel stock, where that row shows mm_size.
//
...
//   GET /server/certified_diamond_label?item_id=<id>            -> PDF, inline (Zoho Inventory)
//   GET /server/certified_diamond_label?product_id=<id>         -> PDF, inline (Zoho CRM Products)
//   GET /server/certified_diamond_label?item_id=<id>&format=ezpl -> raw EZPL text
//
